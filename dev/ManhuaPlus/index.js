...
var source = (() => {
  ...
  var require_types = __commonJS({
    "node_modules/@paperback/types/lib/compat/0.8/types.js"(exports) {
      ...
      })(HomeSectionType3 || (exports.HomeSectionType = HomeSectionType3 = {}));
      var SourceIntents2;
      (function(SourceIntents3) {
        SourceIntents3[SourceIntents3["MANGA_CHAPTERS"] = 1] = "MANGA_CHAPTERS";
        SourceIntents3[SourceIntents3["MANGA_TRACKING"] = 2] = "MANGA_TRACKING";
...
Type: ${row["type"]}`
      ...
      !function(t, e) {
        ...
        var W, O, I, U, K, X, L, l, j, T, t, N, q, e, Z, V, G, J, Q, Y, $2, t1, e1, r1, i1, o1, n1, s, s1, c1, a1, h1, l1, o, f1, r, d1, u1, n, c, a, h, f, d, i = function(h3) {
          ...
          var t3 = {}, o3 = t3.lib = {}, n3 = o3.Base = { extend: function(t4) {
            ...
            if (c4) {
              for (var a4 = 0; a4 < c4; a4 += n4)
                this._doProcessBlock(i4, a4);
          ...
          for (var t3 = W.clone.call(this), e3 = t3.words = this.words.slice(0), r3 = e3.length, i3 = 0; i3 < r3; i3++)
            e3[i3] = e3[i3].clone();
          return t3;
          ...
          if ((t3 = (t3 = t3 instanceof ArrayBuffer ? new Uint8Array(t3) : t3) instanceof Int8Array || "undefined" != typeof Uint8ClampedArray && t3 instanceof Uint8ClampedArray || t3 instanceof Int16Array || t3 instanceof Uint16Array || t3 instanceof Int32Array || t3 instanceof Uint32Array || t3 instanceof Float32Array || t3 instanceof Float64Array ? new Uint8Array(t3.buffer, t3.byteOffset, t3.byteLength) : t3) instanceof Uint8Array) {
            for (var e3 = t3.byteLength, r3 = [], i3 = 0; i3 < e3; i3++)
              r3[i3 >>> 2] |= t3[i3] << 24 - i3 % 4 * 8;
            I.call(this, r3, e3);
          } else
        ...
        (u = u.enc).Utf16 = u.Utf16BE = { stringify: function(t3) {
          ...
          for (var e3 = t3.length, r3 = [], i3 = 0; i3 < e3; i3++)
            r3[i3 >>> 1] |= _1(t3.charCodeAt(i3) << 16 - i3 % 2 * 16);
          return p1.create(r3, 2 * e3);
        } }, U = (p = i).lib.WordArray, p.enc.Base64 = { stringify: function(t3) {
          for (var e3 = t3.words, r3 = t3.sigBytes, i3 = this._map, o3 = (t3.clamp(), []), n3 = 0; n3 < r3; n3 += 3)
            for (var s3 = (e3[n3 >>> 2] >>> 24 - n3 % 4 * 8 & 255) << 16 | (e3[n3 + 1 >>> 2] >>> 24 - (n3 + 1) % 4 * 8 & 255) << 8 | e3[n3 + 2 >>> 2] >>> 24 - (n3 + 2) % 4 * 8 & 255, c3 = 0; c3 < 4 && n3 + 0.75 * c3 < r3; c3++)
              o3.push(i3.charAt(s3 >>> 6 * (3 - c3) & 63));
          var a3 = i3.charAt(64);
          if (a3)
            for (; o3.length % 4; )
              o3.push(a3);
          ...
          if (!(i3 = this._reverseMap))
            for (var i3 = this._reverseMap = [], o3 = 0; o3 < r3.length; o3++)
              i3[r3.charCodeAt(o3)] = o3;
          for (var n3, s3, c3 = r3.charAt(64), a3 = (!c3 || -1 !== (c3 = t3.indexOf(c3)) && (e3 = c3), t3), h3 = e3, l3 = i3, f3 = [], d3 = 0, u3 = 0; u3 < h3; u3++)
            u3 % 4 && (s3 = l3[a3.charCodeAt(u3 - 1)] << u3 % 4 * 2, n3 = l3[a3.charCodeAt(u3)] >>> 6 - u3 % 4 * 2, s3 = s3 | n3, f3[d3 >>> 2] |= s3 << 24 - d3 % 4 * 8, d3++);
          ...
          for (var r3 = t3.words, i3 = t3.sigBytes, o3 = (e3 = void 0 === e3 ? true : e3) ? this._safe_map : this._map, n3 = (t3.clamp(), []), s3 = 0; s3 < i3; s3 += 3)
            for (var c3 = (r3[s3 >>> 2] >>> 24 - s3 % 4 * 8 & 255) << 16 | (r3[s3 + 1 >>> 2] >>> 24 - (s3 + 1) % 4 * 8 & 255) << 8 | r3[s3 + 2 >>> 2] >>> 24 - (s3 + 2) % 4 * 8 & 255, a3 = 0; a3 < 4 && s3 + 0.75 * a3 < i3; a3++)
              n3.push(o3.charAt(c3 >>> 6 * (3 - a3) & 63));
          var h3 = o3.charAt(64);
          if (h3)
            for (; n3.length % 4; )
              n3.push(h3);
          ...
          if (!(o3 = this._reverseMap))
            for (var o3 = this._reverseMap = [], n3 = 0; n3 < i3.length; n3++)
              o3[i3.charCodeAt(n3)] = n3;
          for (var s3, c3, e3 = i3.charAt(64), a3 = (!e3 || -1 !== (e3 = t3.indexOf(e3)) && (r3 = e3), t3), h3 = r3, l3 = o3, f3 = [], d3 = 0, u3 = 0; u3 < h3; u3++)
            u3 % 4 && (c3 = l3[a3.charCodeAt(u3 - 1)] << u3 % 4 * 2, s3 = l3[a3.charCodeAt(u3)] >>> 6 - u3 % 4 * 2, c3 = c3 | s3, f3[d3 >>> 2] |= c3 << 24 - d3 % 4 * 8, d3++);
        ...
        for (var A1 = 2, z1 = 0; z1 < 64; )
          !function(t3) {
            for (var e3 = w1.sqrt(t3), r3 = 2; r3 <= e3; r3++)
              if (!(t3 % r3))
                return;
            return 1;
        ...
        u = u.SHA3 = F1.extend({ cfg: F1.cfg.extend({ outputLength: 512 }), _doReset: function() {
          ...
          for (var c3 = 0; c3 < 24; c3++) {
            for (var a3 = 0; a3 < 5; a3++) {
              for (var h3 = 0, l3 = 0, f3 = 0; f3 < 5; f3++)
                h3 ^= (x3 = r3[a3 + 5 * f3]).high, l3 ^= x3.low;
              var d3 = D[a3];
              d3.high = h3, d3.low = l3;
            }
            for (a3 = 0; a3 < 5; a3++)
              for (var u3 = D[(a3 + 4) % 5], p3 = D[(a3 + 1) % 5], _3 = p3.high, p3 = p3.low, h3 = u3.high ^ (_3 << 1 | p3 >>> 31), l3 = u3.low ^ (p3 << 1 | _3 >>> 31), f3 = 0; f3 < 5; f3++)
                (x3 = r3[a3 + 5 * f3]).high ^= h3, x3.low ^= l3;
          ...
          for (var t3 = F1.clone.call(this), e3 = t3._state = this._state.slice(0), r3 = 0; r3 < 25; r3++)
            e3[r3] = e3[r3].clone();
          return t3;
          ...
          for (var n3, s3, c3, a3, h3, l3, f3 = this._hash.words, d3 = Y.words, u3 = $2.words, p3 = V.words, _3 = G.words, y3 = J.words, g3 = Q.words, v3 = n3 = f3[0], B3 = s3 = f3[1], w3 = c3 = f3[2], k3 = a3 = f3[3], x3 = h3 = f3[4], r3 = 0; r3 < 80; r3 += 1)
            l3 = (l3 = Q1(l3 = (l3 = n3 + t3[e3 + p3[r3]] | 0) + (r3 < 16 ? (s3 ^ c3 ^ a3) + d3[0] : r3 < 32 ? G1(s3, c3, a3) + d3[1] : r3 < 48 ? ((s3 | ~c3) ^ a3) + d3[2] : r3 < 64 ? J1(s3, c3, a3) + d3[3] : (s3 ^ (c3 | ~a3)) + d3[4]) | 0, y3[r3])) + h3 | 0, n3 = h3, h3 = a3, a3 = Q1(c3, 10), c3 = s3, s3 = l3, l3 = (l3 = Q1(l3 = (l3 = v3 + t3[e3 + _3[r3]] | 0) + (r3 < 16 ? (B3 ^ (w3 | ~k3)) + u3[0] : r3 < 32 ? J1(B3, w3, k3) + u3[1] : r3 < 48 ? ((B3 | ~w3) ^ k3) + u3[2] : r3 < 64 ? G1(B3, w3, k3) + u3[3] : (B3 ^ w3 ^ k3) + u3[4]) | 0, g3[r3])) + x3 | 0, v3 = x3, x3 = k3, k3 = Q1(w3, 10), w3 = B3, B3 = l3;
          ...
          for (var r3 = t3.blockSize, i3 = 4 * r3, t3 = ((e3 = e3.sigBytes > i3 ? t3.finalize(e3) : e3).clamp(), this._oKey = e3.clone()), e3 = this._iKey = e3.clone(), o3 = t3.words, n3 = e3.words, s3 = 0; s3 < r3; s3++)
            o3[s3] ^= 1549556828, n3[s3] ^= 909522486;
          ...
          for (var r3 = this.cfg, i3 = r1.create(r3.hasher, t3), o3 = e1.create(), n3 = e1.create([1]), s3 = o3.words, c3 = n3.words, a3 = r3.keySize, h3 = r3.iterations; s3.length < a3; ) {
            for (var l3 = i3.update(e3).finalize(n3), f3 = (i3.reset(), l3.words), d3 = f3.length, u3 = l3, p3 = 1; p3 < h3; p3++) {
              ...
              for (var _3 = u3.words, y3 = 0; y3 < d3; y3++)
                f3[y3] ^= _3[y3];
            }
            o3.concat(l3), c3[0]++;
          }
          ...
          for (var r3, i3 = this.cfg, o3 = i3.hasher.create(), n3 = o1.create(), s3 = n3.words, c3 = i3.keySize, a3 = i3.iterations; s3.length < c3; ) {
            ...
            for (var h3 = 1; h3 < a3; h3++)
              r3 = o3.finalize(r3), o3.reset();
            n3.concat(r3);
          }
          ...
          for (var e3 = 4 * e3, r3 = e3 - t3.sigBytes % e3, i3 = r3 << 24 | r3 << 16 | r3 << 8 | r3, o3 = [], n3 = 0; n3 < r3; n3 += 4)
            o3.push(i3);
          e3 = s.create(o3, r3);
          t3.concat(e3);
        }, unpad: function(t3) {
          ...
          for (var e3 = t3.words, r3 = t3.sigBytes - 1, r3 = t3.sigBytes - 1; 0 <= r3; r3--)
        ...
        var p2 = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], u = u.AES = p.extend({ _doReset: function() {
          if (!this._nRounds || this._keyPriorReset !== this._key) {
            for (var t3 = this._keyPriorReset = this._key, e3 = t3.words, r3 = t3.sigBytes / 4, i3 = 4 * (1 + (this._nRounds = 6 + r3)), o3 = this._keySchedule = [], n3 = 0; n3 < i3; n3++)
              n3 < r3 ? o3[n3] = e3[n3] : (a3 = o3[n3 - 1], n3 % r3 ? 6 < r3 && n3 % r3 == 4 && (a3 = k[a3 >>> 24] << 24 | k[a3 >>> 16 & 255] << 16 | k[a3 >>> 8 & 255] << 8 | k[255 & a3]) : (a3 = k[(a3 = a3 << 8 | a3 >>> 24) >>> 24] << 24 | k[a3 >>> 16 & 255] << 16 | k[a3 >>> 8 & 255] << 8 | k[255 & a3], a3 ^= p2[n3 / r3 | 0] << 24), o3[n3] = o3[n3 - r3] ^ a3);
          ...
          for (var a3 = this._nRounds, h3 = t3[e3] ^ r3[0], l3 = t3[e3 + 1] ^ r3[1], f3 = t3[e3 + 2] ^ r3[2], d3 = t3[e3 + 3] ^ r3[3], u3 = 4, p3 = 1; p3 < a3; p3++)
            var _3 = i3[h3 >>> 24] ^ o3[l3 >>> 16 & 255] ^ n3[f3 >>> 8 & 255] ^ s3[255 & d3] ^ r3[u3++], y3 = i3[l3 >>> 24] ^ o3[f3 >>> 16 & 255] ^ n3[d3 >>> 8 & 255] ^ s3[255 & h3] ^ r3[u3++], g3 = i3[f3 >>> 24] ^ o3[d3 >>> 16 & 255] ^ n3[h3 >>> 8 & 255] ^ s3[255 & l3] ^ r3[u3++], v3 = i3[d3 >>> 24] ^ o3[h3 >>> 16 & 255] ^ n3[l3 >>> 8 & 255] ^ s3[255 & f3] ^ r3[u3++], h3 = _3, l3 = y3, f3 = g3, d3 = v3;
          ...
          for (var o3 = this._subKeys = [], n3 = 0; n3 < 16; n3++) {
            for (var s3 = o3[n3] = [], c3 = v2[n3], r3 = 0; r3 < 24; r3++)
              s3[r3 / 6 | 0] |= e3[(g2[r3] - 1 + c3) % 28] << 31 - r3 % 6, s3[4 + (r3 / 6 | 0)] |= e3[28 + (g2[r3 + 24] - 1 + c3) % 28] << 31 - r3 % 6;
            s3[0] = s3[0] << 1 | s3[0] >>> 31;
            for (r3 = 1; r3 < 7; r3++)
              s3[r3] = s3[r3] >>> 4 * (r3 - 1) + 3;
            s3[7] = s3[7] << 5 | s3[7] >>> 27;
          }
          for (var a3 = this._invSubKeys = [], r3 = 0; r3 < 16; r3++)
            a3[r3] = o3[15 - r3];
        }, encryptBlock: function(t3, e3) {
          ...
          for (var i3 = 0; i3 < 16; i3++) {
            for (var o3 = r3[i3], n3 = this._lBlock, s3 = this._rBlock, c3 = 0, a3 = 0; a3 < 8; a3++)
              c3 |= B2[a3][((s3 ^ o3[a3]) & w2[a3]) >>> 0];
        ...
        var u = i, P = u.lib.StreamCipher, w = u.algo, m2 = w.RC4 = P.extend({ _doReset: function() {
          for (var t3 = this._key, e3 = t3.words, r3 = t3.sigBytes, i3 = this._S = [], o3 = 0; o3 < 256; o3++)
            i3[o3] = o3;
        ...
        u.RC4 = P._createHelper(m2), w = w.RC4Drop = m2.extend({ cfg: m2.cfg.extend({ drop: 192 }), _doReset: function() {
          ...
          for (var i3 = 0; i3 < 4; i3++)
            n[i3] = 16711935 & (n[i3] << 8 | n[i3] >>> 24) | 4278255360 & (n[i3] << 24 | n[i3] >>> 8), t3[e3 + i3] ^= n[i3];
          ...
          for (var i3 = 0; i3 < 4; i3++)
            h[i3] = 16711935 & (h[i3] << 8 | h[i3] >>> 24) | 4278255360 & (h[i3] << 24 | h[i3] >>> 8), t3[e3 + i3] ^= h[i3];
        }, blockSize: 4, ivSize: 2 }), w.RabbitLegacy = p._createHelper(u);
        {
          let C22 = function(t3, e3) {
            ...
            for (let t4 = 0; t4 < F; ++t4)
              i3 ^= e3.pbox[t4], o3 = C22(e3, i3) ^ o3, n3 = i3, i3 = o3, o3 = n3;
          ...
          p = p.Blowfish = w.extend({ _doReset: function() {
              ...
              var t3 = this._keyPriorReset = this._key, n3 = t3.words, t3 = t3.sigBytes / 4;
              {
                ...
                for (let e4 = 0; e4 < 4; e4++) {
                  ...
                  for (let t4 = 0; t4 < 256; t4++)
                    s3.sbox[e4][t4] = E2[e4][t4];
                }
                let e3 = 0;
                for (let t4 = 0; t4 < F + 2; t4++)
                  s3.pbox[t4] = D2[t4] ^ c3[e3], ++e3 >= a3 && (e3 = 0);
                let r3 = 0, i3 = 0, o3 = 0;
                for (let t4 = 0; t4 < F + 2; t4 += 2)
                  o3 = R22(s3, r3, i3), r3 = o3.left, i3 = o3.right, s3.pbox[t4] = r3, s3.pbox[t4 + 1] = i3;
                for (let e4 = 0; e4 < 4; e4++)
                  for (let t4 = 0; t4 < 256; t4 += 2)
                    o3 = R22(s3, r3, i3), r3 = o3.left, i3 = o3.right, s3.sbox[e4][t4] = r3, s3.sbox[e4][t4 + 1] = i3;
              }
            }
          }, encryptBlock: function(t3, e3) {
            ...
            var r3 = function(e4, t4, r4) {
              let i3 = t4, o3 = r4, n3;
              for (let t5 = F + 1; 1 < t5; --t5)
                i3 ^= e4.pbox[t5], o3 = C22(e4, i3) ^ o3, n3 = i3, i3 = o3, o3 = n3;
  ...
  var Madara = class extends import__.Source {
    constructor() {
      super(...arguments);
      /**
...
Please go to the homepage of <${this.baseUrl}> and press the cloud icon.`);
  ...
  var ManhuaPlusInfo = {
    ...
    icon: "icon.png",
    contentRating: import__2.ContentRating.EVERYONE,
    websiteBaseURL: DOMAIN,
    sourceTags: [],
    intents: import__2.SourceIntents.MANGA_CHAPTERS | import__2.SourceIntents.HOMEPAGE_SECTIONS | import__2.SourceIntents.CLOUDFLARE_BYPASS_REQUIRED | import__2.SourceIntents.SETTINGS_UI
  };
      ...
      const sections = [
        {
          ...
          section: App.createHomeSection({
            id: "0",
            title: "Recently Updated",
            type: import__2.HomeSectionType.singleRowNormal,
            containsMoreItems: true
          })
        },
        {
